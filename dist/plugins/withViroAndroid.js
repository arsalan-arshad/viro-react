...
'android',
async (config) => {
const mainApplicationPath = path_1.default.join(
...
viroPluginConfig = viroPlugin[1].androidXrMode.filter((mode) =>
...
fs_1.default.writeFile(mainApplicationPath, data, 'utf-8', function (
err,
) {
